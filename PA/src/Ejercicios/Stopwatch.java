...
public class Stopwatch extends JFrame {
	...
	public Stopwatch() {
		...
		gbl_contentPane.columnWidths = new int [] {20,20,20};
		gbl_contentPane.rowHeights = new int [] {20,20,20};
		gbl_contentPane.columnWeights = new double[]{1.0, 1.0,1.0};
		gbl_contentPane.rowWeights = new double[]{1.0, 1.0,1.0};
		contentPane.setLayout(gbl_contentPane);
		
		JButton btnNewButton = new JButton("Start Timing");
		...
		JLabel lblNewLabel = new JLabel("Star Time");
		...
		JButton btnNewButton_1 = new JButton("Stop Timing ");
		...
		JLabel lblNewLabel_1 = new JLabel("Stop Time ");
		...
		JLabel lblNewLabel_2 = new JLabel("Elapsed Time (sec)");
